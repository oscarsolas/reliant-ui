...
var _reliantButton = __webpack_require__(24);

var _reliantButton2 = _interopRequireDefault(_reliantButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// initialization react
_reactDom2.default.render(_react2.default.createElement(
  _reliantButton2.default,
  { to: '#' },
  'Example button'
), document.querySelector('.content')); // import react
...
var _anime = __webpack_require__(25);
...
exports.default = ReliantButton = function (_React$Component) {
  _inherits(ReliantButton, _React$Component);

  function ReliantButton(props) {
    _classCallCheck(this, ReliantButton);

    var _this = _possibleConstructorReturn(this, (ReliantButton.__proto__ || Object.getPrototypeOf(ReliantButton)).call(this, props));
  ...
  _createClass(ReliantButton, [{
    key: 'animateLine',
    value: function animateLine(element, to) {
      if (this.animation) {
        this.animation.pause();
      }
      return this.animation = (0, _anime2.default)({
        targets: element,
    ...
    key: 'animateRadius',
    value: function animateRadius(element, to, move) {
      if (this.animation2) {
        this.animation2.pause();
      }
      return this.animation2 = (0, _anime2.default)({
        targets: element,
    ...
    key: 'animatePadding',
    value: function animatePadding(element, to) {
      if (this.animation3) {
        this.animation3.pause();
      }
      return this.animation3 = (0, _anime2.default)({
        targets: element,
        paddingRight: to
      });
    }
    ...
    value: function animateArrowIn() {
      ...
      this.animation4 = _anime2.default.timeline();
    ...
    key: 'animateArrowOut',
    value: function animateArrowOut() {
      var arrow, arrowBottom, arrowTop;
      arrow = this.refs.arrow;
      arrowTop = this.refs.arrow_top;
      arrowBottom = this.refs.arrow_bottom;
      ...
      this.animation5 = _anime2.default.timeline();
    ...
    key: 'animatecircleIn',
    value: function animatecircleIn() {
      var circle;
      ...
      this.animation6 = _anime2.default.timeline();
    ...
    key: 'animatecircleOut',
    value: function animatecircleOut() {
      var circle;
      circle = this.refs.circle;
      if (this.animation7) {
        this.animation7.pause();
      ...
      this.animation7 = _anime2.default.timeline();
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'a',
        { href: 'to', onMouseOver: function onMouseOver(e) {
            return _this2.hover(e);
          }, onMouseOut: function onMouseOut(e) {
            return _this2.out(e);
          }, className: 'reliant-button' },
        _react2.default.createElement(
          'div',
          { ref: 'button_wrapper', className: 'reliant-button_wrapper' },
          _react2.default.createElement(
            'div',
            null,
            this.props.children
          ...
          _react2.default.createElement(
            'svg',
            { xmlns: 'http://www.w3.org/2000/svg', preserveAspectRatio: 'none', className: 'slick' },
            _react2.default.createElement('path', { d: 'M 0 36 L 0 0 L 20 0 A 0 10 0 1 1 20 36 Z', ref: 'lineTop' })
          ),
          _react2.default.createElement(
            'div',
            { ref: 'arrow', className: 'arrow' },
            _react2.default.createElement('span', { ref: 'arrow_top', className: 'arrow_top' }),
            _react2.default.createElement('span', { ref: 'arrow_bottom', className: 'arrow_bottom' })
          ),
          _react2.default.createElement('div', { ref: 'circle', style: {
              scale: 0
            }, className: 'circle' })
        )
      );
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../tools/node_modules/css-loader/index.js!../tools/node_modules/postcss-loader/lib/index.js??ref--3-2!../tools/node_modules/sass-loader/lib/loader.js!./reliant-button.scss", function() {
			var newContent = require("!!../tools/node_modules/css-loader/index.js!../tools/node_modules/postcss-loader/lib/index.js??ref--3-2!../tools/node_modules/sass-loader/lib/loader.js!./reliant-button.scss");
